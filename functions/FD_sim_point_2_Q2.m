function w3=FD_sim_point_2_Q2(Vp,Vs,rho,X,Y,Z,source,pulse,TP,TS,tsl,Dt,maxt,posx,posy,posz,gpumode,N,b,topoload,topo,X_topo,Y_topo,savemode,savetype,skipt,outpath)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%INPUT DATA%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if length(TP)==1
    ...
    indtii_TP1=2:ny-1;indtii_TP2=2:nx-1;indtii_TP3=2:nz-1;
end
...
if length(TS)==1
    ...
    indtii_TS1=2:ny-1;indtii_TS2=2:nx-1;indtii_TS3=2:nz-1;
    indtxy_TS1=2:ny;indtxy_TS2=2:nx;indtxy_TS3=1:nz-1;
    indtxz_TS1=1:ny-1;indtxz_TS2=2:nx;indtxz_TS3=2:nz;
    indtyz_TS1=2:ny;indtyz_TS2=1:nx-1;indtyz_TS3=2:nz;
end
...
if length(tsl)==1
    ...
    indtii_tsl1=2:ny-1;indtii_tsl2=2:nx-1;indtii_tsl3=2:nz-1;
    indtxy_tsl1=2:ny;indtxy_tsl2=2:nx;indtxy_tsl3=1:nz-1;
    indtxz_tsl1=1:ny-1;indtxz_tsl2=2:nx;indtxz_tsl3=2:nz;
    indtyz_tsl1=2:ny;indtyz_tsl2=1:nx-1;indtyz_tsl3=2:nz;
end
...
for t=1:maxt
    ...
    Vx_new(1:end-1,1:end-1,1:end-1)=(Vx_new(1:end-1,1:end-1,1:end-1)+...
    ...
    Vy_new(1:end-1,1:end-1,1:end-1)=(Vy_new(1:end-1,1:end-1,1:end-1)+...
        ((Dt.*(1./(rho(1:end-1,1:end-1,1:end-1)))).*...
    ...
    Vz_new(1:end-1,1:end-1,1:end-1)=(Vz_new(1:end-1,1:end-1,1:end-1)+...
        ((Dt.*(1./(rho(1:end-1,1:end-1,1:end-1)))).*...
    ...
    rxx(2:end-1,2:end-1,2:end-1)=(((1+(Dt.*0.5.*tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3))).^-1).*...
        (((1-(Dt.*0.5.*tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3))).*rxx(2:end-1,2:end-1,2:end-1))-...
        ((lamda(2:end-1,2:end-1,2:end-1).*Dt./tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3)).*...
        TP(indtii_TP1,indtii_TP2,indtii_TP3).*...
        (((Vx_new(2:end-1,2:end-1,2:end-1)-Vx_new(2:end-1,1:end-2,2:end-1))./Dhx(2:end-1))+...
        ((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1))+...
        ((Vz_new(2:end-1,2:end-1,2:end-1)-Vz_new(2:end-1,2:end-1,1:end-2))./Dhz(2:end-1))))+...
        (2.*Dt.*mu(2:end-1,2:end-1,2:end-1)./tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3)).*...
        TS(indtii_TS1,indtii_TS2,indtii_TS3).*...
        (((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1))+...
        ((Vz_new(2:end-1,2:end-1,2:end-1)-Vz_new(2:end-1,2:end-1,1:end-2))./Dhz(2:end-1)))));
    
    % Calculate ryy relaation funciton 
    ryy(2:end-1,2:end-1,2:end-1)=(((1+(Dt.*0.5.*tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3))).^-1).*...
        (((1-(Dt./2.*tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3))).*ryy(2:end-1,2:end-1,2:end-1))-...
        ((lamda(2:end-1,2:end-1,2:end-1).*Dt./tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3)).*...
        TP(indtii_TP1,indtii_TP2,indtii_TP3).*...
        (((Vx_new(2:end-1,2:end-1,2:end-1)-Vx_new(2:end-1,1:end-2,2:end-1))./Dhx(2:end-1))+...
        ((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1))+...
    ...
    rzz(2:end-1,2:end-1,2:end-1)=(((1+(Dt./2.*tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3))).^-1).*...
        (((1-(Dt./2.*tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3))).*rzz(2:end-1,2:end-1,2:end-1))-...
        ((lamda(2:end-1,2:end-1,2:end-1).*Dt./tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3)).*...
        TP(indtii_TP1,indtii_TP2,indtii_TP3).*...
        (((Vx_new(2:end-1,2:end-1,2:end-1)-Vx_new(2:end-1,1:end-2,2:end-1))./Dhx(2:end-1))+...
        ((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1))+...
    ...
    rxy(2:end,2:end,1:end-1)=(((1+(Dt./2.*tsl(indtxy_tsl1,indtxy_tsl2,indtxy_tsl3))).^-1).*...
        (((1-(Dt./2.*tsl(indtxy_tsl1,indtxy_tsl2,indtxy_tsl3))).*rxy(2:end,2:end,1:end-1))-...
        ((mu(2:end,2:end,1:end-1).*Dt./tsl(indtxy_tsl1,indtxy_tsl2,indtxy_tsl3)).*...
    ...
    rxz(1:end-1,2:end,2:end)=(((1+(Dt./2.*tsl(indtxz_tsl1,indtxz_tsl2,indtxz_tsl3))).^-1).*...
        (((1-(Dt./2.*tsl(indtxz_tsl1,indtxz_tsl2,indtxz_tsl3))).*rxz(1:end-1,2:end,2:end))-...
        ((mu(1:end-1,2:end,2:end).*Dt./tsl(indtxz_tsl1,indtxz_tsl2,indtxz_tsl3)).*...
    ...
    ryz(2:end,1:end-1,2:end)=(((1+(Dt./2.*tsl(indtyz_tsl1,indtyz_tsl2,indtyz_tsl3))).^-1).*...
        (((1-(Dt./2.*tsl(indtyz_tsl1,indtyz_tsl2,indtyz_tsl3))).*ryz(2:end,1:end-1,2:end))-...
        ((mu(2:end,2:end,1:end-1).*Dt./tsl(indtyz_tsl1,indtyz_tsl2,indtyz_tsl3)).*...
    ...
    txx(2:end-1,2:end-1,2:end-1)=txx(2:end-1,2:end-1,2:end-1)+((Dt.*lamda(2:end-1,2:end-1,2:end-1)).*...
        ((1+TP(indtii_TP1,indtii_TP2,indtii_TP3)).*...
        (((Vx_new(2:end-1,2:end-1,2:end-1)-Vx_new(2:end-1,1:end-2,2:end-1))./Dhx(2:end-1))+...
        ((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1))+...
        ((Vz_new(2:end-1,2:end-1,2:end-1)-Vz_new(2:end-1,2:end-1,1:end-2))./Dhz(2:end-1))))-...
        (Dt.*2.*mu(2:end-1,2:end-1,2:end-1)).*((1+TS(indtii_TS1,indtii_TS2,indtii_TS3)).*...
        (((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1))+...
        ((Vz_new(2:end-1,2:end-1,2:end-1)-Vz_new(2:end-1,2:end-1,1:end-2))./Dhz(2:end-1)))))+...
        (Dt/2).*(rxx(2:end-1,2:end-1,2:end-1));

    % Calculate tyy stress component
    tyy(2:end-1,2:end-1,2:end-1)=tyy(2:end-1,2:end-1,2:end-1)+((Dt.*lamda(2:end-1,2:end-1,2:end-1)).*...
        ((1+TP(indtii_TP1,indtii_TP2,indtii_TP3)).*...
        (((Vx_new(2:end-1,2:end-1,2:end-1)-Vx_new(2:end-1,1:end-2,2:end-1))./Dhx(2:end-1))+...
        ((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1))+...
        ((Vz_new(2:end-1,2:end-1,2:end-1)-Vz_new(2:end-1,2:end-1,1:end-2))./Dhz(2:end-1))))-...
        ...
        (((Vx_new(2:end-1,2:end-1,2:end-1)-Vx_new(2:end-1,1:end-2,2:end-1))./Dhx(2:end-1))+...
        ((Vz_new(2:end-1,2:end-1,2:end-1)-Vz_new(2:end-1,2:end-1,1:end-2))./Dhz(2:end-1)))))+...
        (Dt/2).*(ryy(2:end-1,2:end-1,2:end-1));

    % Calculate tzz stress component
    tzz(2:end-1,2:end-1,2:end-1)=tzz(2:end-1,2:end-1,2:end-1)+((Dt.*lamda(2:end-1,2:end-1,2:end-1)).*...
        ((1+TP(indtii_TP1,indtii_TP2,indtii_TP3)).*...
        (((Vx_new(2:end-1,2:end-1,2:end-1)-Vx_new(2:end-1,1:end-2,2:end-1))./Dhx(2:end-1))+...
        ((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1))+...
        ((Vz_new(2:end-1,2:end-1,2:end-1)-Vz_new(2:end-1,2:end-1,1:end-2))./Dhz(2:end-1))))-...
        ...
        (((Vx_new(2:end-1,2:end-1,2:end-1)-Vx_new(2:end-1,1:end-2,2:end-1))./Dhx(2:end-1))+...
        ((Vy_new(2:end-1,2:end-1,2:end-1)-Vy_new(1:end-2,2:end-1,2:end-1))./Dhy(2:end-1)))))+...
        (Dt/2).*(rzz(2:end-1,2:end-1,2:end-1));

    % Calculate txy stress component
    txy(2:end,2:end,1:end-1)=txy(2:end,2:end,1:end-1)+...
        (mu(2:end,2:end,1:end-1).*Dt).*((1+TS(indtxy_TS1,indtxy_TS2,indtxy_TS3)).*...
        (((Vx_new(2:end,1:end-1,1:end-1)-Vx_new(1:end-1,1:end-1,1:end-1))./Dhy(1:end-1))+...
        ((Vy_new(1:end-1,2:end,1:end-1)-Vy_new(1:end-1,1:end-1,1:end-1))./Dhx(1:end-1))))+...
        (Dt/2).*(rxy(2:end,2:end,1:end-1));

    % Calculate txz stress component
    txz(1:end-1,2:end,2:end)=txz(1:end-1,2:end,2:end)+...
        (mu(1:end-1,2:end,2:end).*Dt).*((1+TS(indtxz_TS1,indtxz_TS2,indtxz_TS3)).*...
        (((Vx_new(1:end-1,1:end-1,2:end)-Vx_new(1:end-1,1:end-1,1:end-1))./Dhz(1:end-1))+...
        ((Vz_new(1:end-1,2:end,1:end-1)-Vz_new(1:end-1,1:end-1,1:end-1))./Dhx(1:end-1))))+...
        (Dt/2).*(rxz(1:end-1,2:end,2:end));

    % Calculate tyz stress component
    tyz(2:end,1:end-1,2:end)=tyz(2:end,1:end-1,2:end)+...
        (mu(2:end,1:end-1,2:end).*Dt).*((1+TS(indtyz_TS1,indtyz_TS2,indtyz_TS3)).*...
        (((Vz_new(2:end,1:end-1,1:end-1)-Vz_new(1:end-1,1:end-1,1:end-1))./Dhy(1:end-1))+...
        ((Vy_new(1:end-1,1:end-1,2:end)-Vy_new(1:end-1,1:end-1,1:end-1))./Dhz(1:end-1))))+...
        (Dt/2).*(ryz(2:end,1:end-1,2:end));
