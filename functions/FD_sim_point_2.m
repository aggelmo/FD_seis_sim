function w3=FD_sim_point_2(Vp,Vs,rho,X,Y,Z,source,pulse,Q,f0,Dt,maxt,posx,posy,posz,gpumode,N,b,topoload,topo,X_topo,Y_topo,savemode,savetype,skipt,outpath)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%INPUT DATA%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for t=1:maxt
    ...
    % Higdon ABC. Values of Lame parameters of normal stress nodes are used!! (no apparent difference if otherwise...)
    wb=((1:N)-1)/N;
    % Boundary y=1
