function w3=FD_sim_point_4(Vp,Vs,rho,X,Y,Z,source,pulse,Q,f0,Dt,maxt,posx,posy,posz,gpumode,N,b,topoload,topo,X_topo,Y_topo,savemode,savetype,skipt,outpath)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%INPUT DATA%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% remove unecessary matrices
clear XX_out YY_out ZZ_out Vp Vs topo X_topo Y_topo Q f0
