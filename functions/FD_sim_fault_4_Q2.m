function w3=FD_sim_fault_4_Q2(Vp,Vs,rho,X,Y,Z,source,pulse,TP,TS,tsl,Dt,maxt,posx,posy,posz,fault,xrup,zrup,gpumode,N,b,topoload,topo,X_topo,Y_topo,savemode,savetype,skipt,outpath)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%INPUT DATA%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for t=1:maxt
    ...
    rxx(3:end-2,3:end-2,3:end-2)=((1+(Dt./2.*tsl(indtii_tsl1,indtii_tsl2,indtii_tsl3)))^-1).*...
        ...
        b.*(Vx_new(3:end-2,4:end-1,3:end-2)-Vx_new(3:end-2,1:end-4,3:end-2)))./Dhx(3:end-2))+...
        ((a.*(Vy_new(3:end-2,3:end-2,3:end-2)-Vy_new(2:end-3,3:end-2,3:end-2))+...
        b.*(Vy_new(4:end-1,3:end-2,3:end-2)-Vy_new(1:end-4,3:end-2,3:end-2)))./Dhy(3:end-2))+...
        ((a.*(Vz_new(3:end-2,3:end-2,3:end-2)-Vz_new(3:end-2,3:end-2,2:end-3))+...
        b.*(Vz_new(3:end-2,3:end-2,4:end-1)-Vz_new(3:end-2,3:end-2,1:end-4)))./Dhz(3:end-2))))+...
    ...
    rxy(3:end-1,3:end-1,2:end-2)=((1+(Dt./2.*tsl(indtxy_tsl1,indtxy_tsl2,indtxy_tsl3)))^-1).*...
        ...
        b.*(Vx_new(4:end,2:end-2,2:end-2)-Vx_new(1:end-3,2:end-2,2:end-2)))./Dhy(2:end-2))+...
        ((a.*(Vy_new(2:end-2,3:end-1,2:end-2)-Vy_new(2:end-2,2:end-2,2:end-2))+...
        b.*(Vy_new(2:end-2,4:end,2:end-2)-Vy_new(2:end-2,1:end-3,2:end-2)))./Dhx(2:end-2)))));
    ...
    rxz(2:end-2,3:end-1,3:end-1)=((1+(Dt./2.*tsl(indtxz_tsl1,indtxz_tsl2,indtxz_tsl3)))^-1).*...
        ...
        b.*(Vx_new(2:end-2,2:end-2,4:end)-Vx_new(2:end-2,2:end-2,1:end-3)))./Dhz(2:end-2))+...
        ((a.*(Vz_new(2:end-2,3:end-1,2:end-2)-Vz_new(2:end-2,2:end-2,2:end-2))+...
        b.*(Vz_new(2:end-2,4:end,2:end-2)-Vz_new(2:end-2,1:end-3,2:end-2)))./Dhx(2:end-2)))));
    ...
    ryz(3:end-1,2:end-2,3:end-1)=((1+(Dt./2.*tsl(indtyz_tsl1,indtyz_tsl2,indtyz_tsl3)))^-1).*...
        ...
        b.*(Vz_new(4:end,2:end-2,2:end-2)-Vz_new(1:end-3,2:end-2,2:end-2)))./Dhy(2:end-2))+...
        ((a.*(Vy_new(2:end-2,2:end-2,3:end-1)-Vy_new(2:end-2,2:end-2,2:end-2))+...
        b.*(Vy_new(2:end-2,2:end-2,4:end)-Vy_new(2:end-2,2:end-2,3:end-1)))./Dhz(2:end-2)))));
