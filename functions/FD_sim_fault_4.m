function w3=FD_sim_fault_4(Vp,Vs,rho,X,Y,Z,source,pulse,Q,f0,Dt,maxt,posx,posy,posz,fault,xrup,zrup,gpumode,N,b,topoload,topo,X_topo,Y_topo,savemode,savetype,skipt,outpath)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%INPUT DATA%%%%%%%%%%%%%%%%%%%%%%%%%%
...
pulse(2:end+1,2)=pulse(1:end,2);pulse(1)=0;
pulse(end,1)=pulse(end-1,1)+(pulse(end-1,1)-pulse(end-2,1));
...
if length(Att)==1
    ...
    indV_Q1=2:ny-2;indV_Q2=2:nx-2;indV_Q3=2:nz-2;
    indtii_Q1=3:ny-2;indtii_Q2=3:nx-2;indtii_Q3=3:nz-2;
    indtxy_Q1=3:ny-1;indtxy_Q2=3:nx-1;indtxy_Q3=2:nz-2;
    indtxz_Q1=2:ny-2;indtxz_Q2=3:nx-1;indtxz_Q3=3:nz-1;
    indtyz_Q1=3:ny-1;indtyz_Q2=2:nx-2;indtyz_Q3=3:nz-1;
end
...
for t=1:maxt
    ...
    Vx_new(2:end-2,2:end-2,2:end-2)=Att(indV_Q1,indV_Q2,indV_Q3).*(Vx_new(2:end-2,2:end-2,2:end-2)+...
    ...
    Vy_new(2:end-2,2:end-2,2:end-2)=Att(indV_Q1,indV_Q2,indV_Q3).*(Vy_new(2:end-2,2:end-2,2:end-2)+...
        ((Dt.*(1./(rho(2:end-2,2:end-2,2:end-2)))).*...
    ...
    Vz_new(2:end-2,2:end-2,2:end-2)=Att(indV_Q1,indV_Q2,indV_Q3).*(Vz_new(2:end-2,2:end-2,2:end-2)+...
        ((Dt.*(1./(rho(2:end-2,2:end-2,2:end-2)))).*...
    ...
    txx(3:end-2,3:end-2,3:end-2)=Att(indtii_Q1,indtii_Q2,indtii_Q3).*(txx(3:end-2,3:end-2,3:end-2)+Dt.*...
        (((lamda(3:end-2,3:end-2,3:end-2)+2.*mu(3:end-2,3:end-2,3:end-2)).*...
    ...
    tyy(3:end-2,3:end-2,3:end-2)=Att(indtii_Q1,indtii_Q2,indtii_Q3).*(tyy(3:end-2,3:end-2,3:end-2)+Dt.*...
        (((lamda(3:end-2,3:end-2,3:end-2)+2.*mu(3:end-2,3:end-2,3:end-2)).*...
        (a.*(Vy_new(3:end-2,3:end-2,3:end-2)-Vy_new(2:end-3,3:end-2,3:end-2))+...
        b2.*(Vy_new(4:end-1,3:end-2,3:end-2)-Vy_new(1:end-4,3:end-2,3:end-2)))./Dhy(3:end-2))+...
        (lamda(3:end-2,3:end-2,3:end-2)).*...
    ...
    tzz(3:end-2,3:end-2,3:end-2)=Att(indtii_Q1,indtii_Q2,indtii_Q3).*(tzz(3:end-2,3:end-2,3:end-2)+Dt.*...
        (((lamda(3:end-2,3:end-2,3:end-2)+2.*mu(3:end-2,3:end-2,3:end-2)).*...
        (a.*(Vz_new(3:end-2,3:end-2,3:end-2)-Vz_new(3:end-2,3:end-2,2:end-3))+...
        b2.*(Vz_new(3:end-2,3:end-2,4:end-1)-Vz_new(3:end-2,3:end-2,1:end-4)))./Dhz(3:end-2))+...    
        (lamda(3:end-2,3:end-2,3:end-2)).*...
    ...
    txy(3:end-1,3:end-1,2:end-2)=Att(indtxy_Q1,indtxy_Q2,indtxy_Q3).*(txy(3:end-1,3:end-1,2:end-2)+...
        (mu(3:end-1,3:end-1,2:end-2).*Dt).*...
    ...
    txz(2:end-2,3:end-1,3:end-1)=Att(indtxz_Q1,indtxz_Q2,indtxz_Q3).*(txz(2:end-2,3:end-1,3:end-1)+...
        (mu(2:end-2,3:end-1,3:end-1).*Dt).*...
    ...
    tyz(3:end-1,2:end-2,3:end-1)=Att(indtyz_Q1,indtyz_Q2,indtyz_Q3).*(tyz(3:end-1,2:end-2,3:end-1)+...
        (mu(3:end-1,2:end-2,3:end-1).*Dt).*...
